...
class PdoM2l
{
    ...
    {
        $req = "select departement.code as codeDep, departement.nom as nomDep from departement";
    ...
    public function getInfosLigue($idLigue){
        $req = "select ligue.id as idLigue, ligue.nom as nomLigue, ligue.adresseRue as adrLigue, ligue.cp as cpLigue, 
                ligue.ville as villeLigue, ligue.emailContact as emailLigue, ligue.tel as telLigue, ligue.olympique as olympLigue,ligue.urlSiteWeb as urlLigue
